...
/************************************ Envoi les infos de modifications synoptique *********************************************/
 function AUDIOZONE_Add_Valider ()
  {
  }
/********************************************* Afichage du modal d'edition synoptique *****************************************/
 function AUDIOZONE_Add ( )
  { $('#idAUDIOZONETitre').text("Ajouter un thread a la zone de diffusion");
    ...
    $('#idAUDIOZONEValider').off("click").on( "click", function ()
     { vars = window.location.pathname.split('/');
       ...
       Send_to_API ( "POST", "/audio/zone/add", json_request, function(Response)
...
/**************************************** Supprime une connexion meteo ********************************************************/
 function AUDIOZONE_Del ( audio_zone_map_id )
  { vars = window.location.pathname.split('/');
           ...
           { "data": null, "title":"Actions", "orderable": false, "className":"align-middle text-center",
             "render": function (item)
               { boutons = Bouton_actions_start ();
                 boutons += Bouton_actions_add ( "danger", "Supprimer le thread de cette zone", "AUDIOZONE_Del", item.audio_zone_map_id, "trash", null );
